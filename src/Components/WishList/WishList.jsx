...
getWishList()
  ...
  return <>
   ...
   {product.id != likedItem?<i onClick={()=>removeProductFromWishList(product.id)} className="fa-solid fa-heart position-absolute top-0 text-danger end-0 p-1 "><i cl></i></i>:""}
...
<div className='text-center not-availbale '>
  ...
  <i class="fa-solid fa-ban fa-5x text-main"></i>
</div>
</div>
